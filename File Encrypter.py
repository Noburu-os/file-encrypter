...
print('')
question = input('type "1" if you want to encrypt using hashlib, if not type "2":')
print('')
question4 = ('2')
...
############START ENCRYPTION#################
  ...
  print('encrytpted file digested = ' + (digested))
  ...
  if word == E_word:
      if word == word:
          if E_word == word:
              print("encryption in progress{}...")
              print("ERR cannot have same name")
              print("sike ;) press enter")
  ...
  hashed_password_file_name = open('hsw.js', 'r')
  ...
  if hashed_password_file_name == hashed_password_file_name:
      ...
      print('file name hexdigested =')
      print(enc_wrd)
      print('')
      print('')
#######
question2 = input('if you want to encrypt using SHA256 type "1", if you want to encrypt your file using a alphabet shifter type "2":')
print('')
print('')
...
if question2 == answer2:
  ...
  print ("Hashed encrypted file:",hashed)
  print('')
  ##
